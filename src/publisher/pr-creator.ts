...
> ⚠️ **Note**: This is an automated fix. Please review carefully before merging.
>
...
<sub>🔑 Fingerprint: \`${context.fingerprint}\` | Generated by [Greenlit](https://github.com/Avinier/greenlit)</sub>
`;
...
function formatFailureCardComment(
  ...
  let body = `## 🚨 Greenlit Failure Card
...
<sub>🔑 Fingerprint: \`${context.fingerprint}\` | Generated by Greenlit</sub>
`;
